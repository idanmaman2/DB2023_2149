...
export default function ImagePager(props: { movies: Movie[] }) {
    ...
    return <div class="flex items-center justify-center w-full h-full gap-20">
            <img class="IMT w-[20vw] h-[38vh] opacity-80 -translate-y-[-2vh] z-0 " src={props.movies![movieShowIndexState() ].poster_images}></img>
        ...
        <img class="IMT w-[20vw] h-[38vh] opacity-80  -translate-y-[-2vh]  z-0 " src={props.movies![getCircularMovieIndex(movieShowIndexState() + 4)].poster_images}></img>
